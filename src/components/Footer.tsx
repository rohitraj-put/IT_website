        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-800 hover:bg-tech-600 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="flex items-center hover:text-tech-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#about" className="flex items-center hover:text-tech-400 transition-colors">
                  <ChevronRight size={16} className="mr-1" />
                  <span>About Us</span>
                </a>
              </li>
              ...
              <li>
                <a href="#contact" className="flex items-center hover:text-tech-400 transition-colors">
                  <ChevronRight size={16} className="mr-1" />
                  <span>Contact</span>
                </a>
              </li>
